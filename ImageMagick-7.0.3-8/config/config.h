...
#define LIBRARY_PATH "/usr/local/lib/ImageMagick-7.0.3/"

/* Subdirectory of lib where ImageMagick architecture dependent files are
   installed. */
#define LIBRARY_RELATIVE_PATH "ImageMagick-7.0.3"
...
#define PACKAGE_STRING "ImageMagick 7.0.3-8"
...
#define PACKAGE_VERSION "7.0.3-8"
